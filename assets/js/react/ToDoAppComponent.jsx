		...
		return (
			<div className="container-fluid">
				{ 
					...
					<List_Component user={this.state.activeUser} logout_function={this.logout} /> 
				}
			</div>
		);
	}
					...
					<div className="container-fluid task-list-container">
						{ 
							...
							unfinished.map(function(task) {
								return <Task_Component key={task.id} task={task} saveAndRerender_function={_this.saveAndRerender} saveChanges_function={_this.saveChanges} />
					        })
